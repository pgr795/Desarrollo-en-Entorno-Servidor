 ...
 <body>
    ...
    <div class="container ">
       ...
       <!--Formulario con botones -->
		...
		<input type="button" value="Alquilar Vehículo" onclick="window.location.href='alquiler_controllers.php'" class="btn btn-warning disabled">
		...
		<input type="button" value="Devolver Vehículo" onclick="window.location.href='Devolver_controllers.php'" class="btn btn-warning disabled">
		</br></br>
