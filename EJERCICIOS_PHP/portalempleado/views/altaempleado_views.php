...
<body>
    ...
    <div class="container ">
			...
			<div class="card-body">
				...
				<form id="" name="" action="../controllers/altaempleado_controllers.php" method="post" class="card-body">
				<div class="form-group">
					...
					Fecha de expiracion <input type="date" name="expirar" class="form-control"><br>
				</div>
				<div class="form-group">
				...
				<input type="submit" name="submit" value="Alta Empleado" class="btn btn-warning disabled">
