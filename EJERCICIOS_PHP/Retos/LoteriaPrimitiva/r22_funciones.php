...
//--------------------------------------------------------------------
//Las funciones que utilizo para Acertantes, Aciertos y Premios
...
function clasificacionAcertantes($num){
    ...
    if($acertante2=="510"||$acertante2=="511"){ //5 aciertos + complementario
        $acertante="7";
    }
...
//600 =8 //510 =7 //500 =6 //400 =5 //300 =4 //001 =3 //200 =2 //100 =1 //000 =0
